...
# enable highlight for Scss code
lexers['scss'] = ScssLexer(startinline=True)

# enable highlight for HTML code
...
html_title = "OroCommerce, OroCRM and OroPlatform Documentation"
...
developer_titles = ['Backend Developer Guide', 'Frontend Developer Guide', 'Oro Bundles and Components', 'Web Services API Guide', 'Community Guide']
