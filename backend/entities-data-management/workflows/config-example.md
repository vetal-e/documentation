<a id="backend-workflows-example"></a>
...
![Workflow Diagram](img/backend/entities_data_management/configuration-reference_workflow-example-entities.png)
...
See more about translations in the [Translations Wizard](translations-wizard.md#backend-workflows-translation-wizard) topic.
...
![Workflow Diagram](img/backend/entities_data_management/configuration-reference_workflow-example-diagram.png)
