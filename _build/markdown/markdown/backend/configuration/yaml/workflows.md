<a id="format-workflow"></a>

# Workflows

#### HINT
For more information, see [Workflow Configuration Reference](../../entities-data-management/workflows/configuration-reference.md#backend-workflows-config-reference).

| Filename   | `workflows.yml`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Root Node  | `workflows`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Sections   | * [attributes]()<br/>  * [entity_acl](#reference-workflow-attributes-entity-acl)<br/>  * [options]()<br/>  * [property_path]()<br/>  * [type]()<br/>* [entity]()<br/>* [entity_attribute]()<br/>* [is_system]()<br/>* [start_step]()<br/>* [steps]()<br/>  * [allowed_transitions]()<br/>  * [entity_acl](#reference-workflow-steps-entity-acl)<br/>  * [is_final]()<br/>  * [order]()<br/>* [steps_display_ordered]()<br/>* [transition_definitions]()<br/>* [transitions]()<br/>  * [acl_message]()<br/>  * [acl_resource]()<br/>  * [dialog_template]()<br/>  * [display_type]()<br/>  * [form_options]()<br/>  * [frontend_options]()<br/>  * [is_hidden]()<br/>  * [is_start]()<br/>  * [is_unavailable_hidden]()<br/>  * [message]()<br/>  * [page_template]()<br/>  * [step_to]()<br/>  * [transition_definition]() |
...
<a id="reference-workflow-attributes-entity-acl"></a>
...
<a id="reference-format-workflow-attributes-property-path"></a>
